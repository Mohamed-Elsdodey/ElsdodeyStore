...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('branches.update',$branch->id)}}">
    @csrf
    @method('PUT')
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input type="file" class="dropify" name="logo" data-default-file="{{get_file($branch->logo)}}"
                   accept="image/*"/>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="fax" required type="text" class="form-control form-control-solid" placeholder="" name="fax"
                   value="{{$branch->fax}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="whatsapp" required type="text" class="form-control form-control-solid" placeholder=""
                   name="whatsapp" value="{{$branch->whatsapp}}"/>
        </div>
        ...
        <div class="my-4">
            ...
            <input type="hidden" value="{{$branch->latitude}}" name="latitude" id="latitude">
            <input type="hidden" value="{{$branch->longitude}}" name="longitude" id="longitude">
            <div class="col-md-12 ps-lg-10">
                <!--begin::Map-->
                <input type="text" value="{{$branch->address}}" name="address" id="pac-input">
            ...
            <script>
                ...
                function initAutocomplete() {
                    var map = new google.maps.Map(document.getElementById('map'), {
                        center: {
                            lat: {{$branch->latitude??23.8859}}, lng: {{$branch->longitude??45.0792}},
                            zoom: 13,
                            mapTypeId: 'roadmap'
                        }
                    });
                    ...
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(function (position) {
                            var pos = {
                                ...
                                lat: {{$branch->latitude??23.8859}},
                                lng: {{$branch->longitude??45.0792}}
                            };
                            map.setCenter(pos);
