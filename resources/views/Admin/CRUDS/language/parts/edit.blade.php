...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('languages.update',$row->id)}}">
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="title" required type="text" class="form-control form-control-solid" placeholder=" " name="abbreviation" value="{{$row->abbreviation}}"/>
        </div>

        <div class="d-flex align-items-center justify-content-between flex-wrap col-md-6 my-4 ">
            <div class="form-check">
                <input @if($row->is_active==1) checked @endif class="form-check-input filterCoupon" data-type="owner" type="radio" name="is_active" id="exampleRadios1" value="1" >
            ...
            <div class="form-check">
                <input @if($row->is_active==0) checked @endif class="form-check-input filterCoupon" type="radio" data-type="owner" name="is_active" id="exampleRadios1" value="0" >
                <label class="form-check-label" for="exampleRadios1">
                    غير مفعل
                </label>
            </div>
